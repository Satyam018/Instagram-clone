...
public class NotificationFragment extends Fragment {
    ...
    private Notificationadapter notificationadapters;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        notificationadapters=new Notificationadapter(getContext(),notificationList);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataSnapshot:snapshot.getChildren()){
                    ...
                    String ispost=dataSnapshot.child("ispost").getValue().toString();
                    if (ispost.equals(true)){
                        notificationList.add(new Notification(userid,text,postid,true));
                    }else{
                        notificationList.add(new Notification(userid,text,postid,false));
                    }
                }
